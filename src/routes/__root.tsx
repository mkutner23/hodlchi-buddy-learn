...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hodlchi Demo" },
      { property: "og:title", content: "Hodlchi Demo" },
      { name: "twitter:title", content: "Hodlchi Demo" },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/778e80dc-1194-42ca-bc6e-5645f4328ace" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/778e80dc-1194-42ca-bc6e-5645f4328ace" },
    ],
    links: [
