...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hodlchi - A virtual pet for better money habits." },
      { property: "og:title", content: "Hodlchi - A virtual pet for better money habits." },
      { name: "twitter:title", content: "Hodlchi - A virtual pet for better money habits." },
      { name: "description", content: "Hodlchi is a virtual pet whose life gets better as your financial life gets better. 5-minute lessons. Daily habits. A companion that grows with you." },
      { property: "og:description", content: "Hodlchi is a virtual pet whose life gets better as your financial life gets better. 5-minute lessons. Daily habits. A companion that grows with you." },
      { name: "twitter:description", content: "Hodlchi is a virtual pet whose life gets better as your financial life gets better. 5-minute lessons. Daily habits. A companion that grows with you." },
